...
if (!is_valid_input) {
  ...
  console.log(
    `EnvironmentalScore is  ${Overall_CVSS_vector.EnvironmentalScore}`
  );
}
...
console.log(result.base_score);
// let base API = result.base_score;
// let temporal API = result.temporal_score;
// let environmental API = result.environmental_score;

// let base = Overall_CVSS_vector.BaseScore;
// let temporal = Overall_CVSS_vector.TemporalScore;
// let environmental = Overall_CVSS_vector.EnvironmentalScore;
